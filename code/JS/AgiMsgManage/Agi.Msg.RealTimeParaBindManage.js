...
Agi.Msg.RealTimeParaBindRelation = function () {
    ...
    this.RemoveItem=function(_ControlOutputPara,_RealtimeIntputPara){
        for (var i = 0; i < this.ParasRelation.length; i++) {
            if (_ControlOutputPara == this.ParasRelation[i].ControlPara && _RealtimeIntputPara==this.ParasRelation[i].EntityPara) {
