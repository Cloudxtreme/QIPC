function MDRclsSigmaFunc(sigmaArray, sigmaRule, checkDataSries)
{
    this.sigmaArray     = sigmaArray;               //所有数据
    this.sigmaRule      = sigmaRule;                //规则
    this.checkDataSries = checkDataSries;           //分组信息
	this.check			= MDRclsSigmaFunc$check;       //调度方法
	this.sigmaRules1	= MDRclsSigmaFunc$sigmaRules1; //规则1
	this.sigmaRules2	= MDRclsSigmaFunc$sigmaRules2; //规则2
	this.sigmaRules3	= MDRclsSigmaFunc$sigmaRules3; //规则3
	this.sigmaRules4	= MDRclsSigmaFunc$sigmaRules4; //规则4
	this.sigmaRules5	= MDRclsSigmaFunc$sigmaRules5; //规则5
	this.sigmaRules6	= MDRclsSigmaFunc$sigmaRules6; //规则6
	this.sigmaRules7	= MDRclsSigmaFunc$sigmaRules7; //规则7
	this.sigmaRules8	= MDRclsSigmaFunc$sigmaRules8; //规则8
    this.sigmaRuleDetail = MDRclsSigmaFunc$getDetail;//根据规则号获取具体规则参数
}

//判定规则调度
function MDRclsSigmaFunc$check()
{
    this.sigmaRules8();
    this.sigmaRules7();
    this.sigmaRules6();
...
//规则1
function MDRclsSigmaFunc$sigmaRules1()
{
	//得到八项规则中的某项K值
	var K;
	//得到八项规则中的某项点的颜色
...
//根据规则号获取具体规则参数
function  MDRclsSigmaFunc$getDetail(ruleNo)
{
    for(var i = 0;i<this.sigmaRule.length;i++){
...
//规则2  连续K点落在中心线同一侧
function MDRclsSigmaFunc$sigmaRules2()
{
    //获取规则
...
function MDRclsSigmaFunc$sigmaRules3()
{
	//得到八项规则中的某项K值
	var K;
	//得到八项规则中的某项点的颜色
...
function MDRclsSigmaFunc$sigmaRules4()
{
	//得到八项规则中的某项K值
	var K;
	//得到八项规则中的某项点的颜色
...
function MDRclsSigmaFunc$sigmaRules5()
{
...
function MDRclsSigmaFunc$sigmaRules6()
{
...
function MDRclsSigmaFunc$sigmaRules7()
{
	//得到八项规则中的某项K值
	var K;
	//得到八项规则中的某项点的颜色
...
function MDRclsSigmaFunc$sigmaRules8()
{
