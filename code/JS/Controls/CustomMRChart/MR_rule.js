function MRclsSigmaFunc(sigmaArray, sigmaRule, checkDataSries)
{
    this.sigmaArray     = sigmaArray;               //所有数据
    this.sigmaRule      = sigmaRule;                //规则
    this.checkDataSries = checkDataSries;           //分组信息
	this.check			= MRclsSigmaFunc$check;       //调度方法
	this.sigmaRules1	= MRclsSigmaFunc$sigmaRules1; //规则1
	this.sigmaRules2	= MRclsSigmaFunc$sigmaRules2; //规则2
	this.sigmaRules3	= MRclsSigmaFunc$sigmaRules3; //规则3
	this.sigmaRules4	= MRclsSigmaFunc$sigmaRules4; //规则4
	this.sigmaRules5	= MRclsSigmaFunc$sigmaRules5; //规则5
	this.sigmaRules6	= MRclsSigmaFunc$sigmaRules6; //规则6
	this.sigmaRules7	= MRclsSigmaFunc$sigmaRules7; //规则7
	this.sigmaRules8	= MRclsSigmaFunc$sigmaRules8; //规则8
    this.sigmaRuleDetail = MRclsSigmaFunc$getDetail;//根据规则号获取具体规则参数
}

//判定规则调度
function MRclsSigmaFunc$check()
{
    this.sigmaRules8();
    this.sigmaRules7();
    this.sigmaRules6();
...
//规则1
function MRclsSigmaFunc$sigmaRules1()
{
	//得到八项规则中的某项K值
	var K;
	//得到八项规则中的某项点的颜色
...
//根据规则号获取具体规则参数
function  MRclsSigmaFunc$getDetail(ruleNo)
{
    for(var i = 0;i<this.sigmaRule.length;i++){
...
//规则2  连续K点落在中心线同一侧
function MRclsSigmaFunc$sigmaRules2()
{
    //获取规则
...
function MRclsSigmaFunc$sigmaRules3()
{
	//得到八项规则中的某项K值
	var K;
	//得到八项规则中的某项点的颜色
...
function MRclsSigmaFunc$sigmaRules4()
{
	//得到八项规则中的某项K值
	var K;
	//得到八项规则中的某项点的颜色
...
function MRclsSigmaFunc$sigmaRules5()
{
...
function MRclsSigmaFunc$sigmaRules6()
{
...
function MRclsSigmaFunc$sigmaRules7()
{
	//得到八项规则中的某项K值
	var K;
	//得到八项规则中的某项点的颜色
...
function MRclsSigmaFunc$sigmaRules8()
{
