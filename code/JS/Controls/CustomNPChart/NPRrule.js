function NPRclsSigmaFunc(sigmaArray, sigmaRule, checkDataSries)
{
    this.sigmaArray     = sigmaArray;               //所有数据
    this.sigmaRule      = sigmaRule;                //规则
    this.checkDataSries = checkDataSries;           //分组信息
	this.check			= NPRclsSigmaFunc$check;       //调度方法
	this.sigmaRules1	= NPRclsSigmaFunc$sigmaRules1; //规则1
	this.sigmaRules2	= NPRclsSigmaFunc$sigmaRules2; //规则2
	this.sigmaRules3	= NPRclsSigmaFunc$sigmaRules3; //规则3
	this.sigmaRules4	= NPRclsSigmaFunc$sigmaRules4; //规则4
	this.sigmaRules5	= NPRclsSigmaFunc$sigmaRules5; //规则5
	this.sigmaRules6	= NPRclsSigmaFunc$sigmaRules6; //规则6
	this.sigmaRules7	= NPRclsSigmaFunc$sigmaRules7; //规则7
	this.sigmaRules8	= NPRclsSigmaFunc$sigmaRules8; //规则8
    this.sigmaRuleDetail = NPRclsSigmaFunc$getDetail;//根据规则号获取具体规则参数
}

//判定规则调度
function NPRclsSigmaFunc$check()
{
//    this.sigmaRules8();
//    this.sigmaRules7();
//    this.sigmaRules6();
...
//规则1
function NPRclsSigmaFunc$sigmaRules1()
{
	//得到八项规则中的某项K值
	var K;
	//得到八项规则中的某项点的颜色
...
//根据规则号获取具体规则参数
function  NPRclsSigmaFunc$getDetail(ruleNo)
{
    for(var i = 0;i<this.sigmaRule.length;i++){
...
//规则2  连续K点落在中心线同一侧
function NPRclsSigmaFunc$sigmaRules2()
{
    //获取规则
...
function NPRclsSigmaFunc$sigmaRules3()
{
	//得到八项规则中的某项K值
	var K;
	//得到八项规则中的某项点的颜色
...
function NPRclsSigmaFunc$sigmaRules4()
{
	//得到八项规则中的某项K值
	var K;
	//得到八项规则中的某项点的颜色
...
function NPRclsSigmaFunc$sigmaRules5()
{
...
function NPRclsSigmaFunc$sigmaRules6()
{
...
function NPRclsSigmaFunc$sigmaRules7()
{
	//得到八项规则中的某项K值
	var K;
	//得到八项规则中的某项点的颜色
...
function NPRclsSigmaFunc$sigmaRules8()
{
