function PNRclsSigmaFunc(sigmaArray, sigmaRule, checkDataSries)
{
    this.sigmaArray     = sigmaArray;               //所有数据
    this.sigmaRule      = sigmaRule;                //规则
    this.checkDataSries = checkDataSries;           //分组信息
	this.check			= PNRclsSigmaFunc$check;       //调度方法
	this.sigmaRules1	= PNRclsSigmaFunc$sigmaRules1; //规则1
	this.sigmaRules2	= PNRclsSigmaFunc$sigmaRules2; //规则2
	this.sigmaRules3	= PNRclsSigmaFunc$sigmaRules3; //规则3
	this.sigmaRules4	= PNRclsSigmaFunc$sigmaRules4; //规则4
	this.sigmaRules5	= PNRclsSigmaFunc$sigmaRules5; //规则5
	this.sigmaRules6	= PNRclsSigmaFunc$sigmaRules6; //规则6
	this.sigmaRules7	= PNRclsSigmaFunc$sigmaRules7; //规则7
	this.sigmaRules8	= PNRclsSigmaFunc$sigmaRules8; //规则8
    this.sigmaRuleDetail = PNRclsSigmaFunc$getDetail;//根据规则号获取具体规则参数
}

//判定规则调度
function PNRclsSigmaFunc$check()
{
//    this.sigmaRules8();
//    this.sigmaRules7();
//    this.sigmaRules6();
...
//规则1
function PNRclsSigmaFunc$sigmaRules1()
{
	//得到八项规则中的某项K值
	var K;
	//得到八项规则中的某项点的颜色
...
//根据规则号获取具体规则参数
function  PNRclsSigmaFunc$getDetail(ruleNo)
{
    for(var i = 0;i<this.sigmaRule.length;i++){
...
//规则2  连续K点落在中心线同一侧
function PNRclsSigmaFunc$sigmaRules2()
{
    //获取规则
...
function PNRclsSigmaFunc$sigmaRules3()
{
	//得到八项规则中的某项K值
	var K;
	//得到八项规则中的某项点的颜色
...
function PNRclsSigmaFunc$sigmaRules4()
{
	//得到八项规则中的某项K值
	var K;
	//得到八项规则中的某项点的颜色
...
function PNRclsSigmaFunc$sigmaRules5()
{
...
function PNRclsSigmaFunc$sigmaRules6()
{
...
function PNRclsSigmaFunc$sigmaRules7()
{
	//得到八项规则中的某项K值
	var K;
	//得到八项规则中的某项点的颜色
...
function PNRclsSigmaFunc$sigmaRules8()
{
