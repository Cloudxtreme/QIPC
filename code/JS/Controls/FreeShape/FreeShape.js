...
Agi.Controls.FreeShape = Agi.OOP.Class.Create(Agi.Controls.ControlBasic,
    {
        ...
        SetShapeData:function(datas){
        	var fs=this.Get('freeshape'),fp=this.Get('FSProPerty');
        ...
        ChartLoadByData:function(_Data){
            ...
            if(_Data!=null && _Data.length>0){
                ...
                var cp = Me.Get('FSProPerty');//cp.SeriesGroupColumn cp.SeriesDataColumn
...
//            var FSProperty=this.Get('FSProperty');
//            $.extend(FSProperty,fsProperty);
//            this.Set('FSProperty', FSProperty);
            this.Set('FSProPerty', fsProperty);
        },
				...
				var shapeOpt={
    				shape:{
    					...
    					style:{
    						...
    						rect:{
    							'fill':fp.fs_fill_color
    						},
    						fillbg:{
    							'fill':fp.fs_fill_bg_color
    						}
    					},
    					animate:1
    				},
		...
		getFsOption:function(){
			var shape=this.Get('freeshape');
			return shape.getOption();
		},
        bingDataGuid:function(control,series){
            ...
            var ChartProperty=control.Get('FSProPerty');
...
//            });
            ...
            FSControl.Control.ChartProperty = this.Get('FSProPerty');
            ...
            FSControl.Control.Setting.TitleVisible=ProPerty.fs_title.visible;
            FSControl.Control.Setting.TitleMulti=ProPerty.fs_title.multi;
            FSControl.Control.Setting.FillColor=ProPerty.fs_fill_color;
            FSControl.Control.Setting.BgColor=ProPerty.fs_fill_bg_color;
            
            FSControl.Control.Setting.TopLineVisible=ProPerty.fs_top_line.visible;
            FSControl.Control.Setting.TopLineColor=ProPerty.fs_top_line.style.stroke;
            FSControl.Control.Setting.TopTextVisible=ProPerty.fs_top_text.visible;
            FSControl.Control.Setting.TopTextColor=ProPerty.fs_top_text.text_color;
            
            FSControl.Control.Setting.BottomLineVisible=ProPerty.fs_bottom_line.visible;
            FSControl.Control.Setting.BottomLineColor=ProPerty.fs_bottom_line.style.stroke;
            FSControl.Control.Setting.BottomTextVisible=ProPerty.fs_bottom_text.visible;
            FSControl.Control.Setting.BottomTextColor=ProPerty.fs_bottom_text.text_color;
            
            FSControl.Control.Setting.ValLineVisible=ProPerty.fs_val_line.visible;
            FSControl.Control.Setting.ValLineColor=ProPerty.fs_val_line.style.stroke;
            FSControl.Control.Setting.ValTextVisible=ProPerty.fs_val_text.visible;
            FSControl.Control.Setting.ValTextColor=ProPerty.fs_val_text.text_color;
        ...
        CreateControl: function (_Config, _Target) {
            ...
            if (_Config != null) {
                ...
                if (_Target != null && _Target != "") {
                    ...
                    this.Set('FSProPerty', chartProperty);
                    ...
                    var ThisProPerty = this.Get('FSProPerty');
...
Agi.Controls.CustomSigChartView_SigmaSettingMenu=function(_Panel,_Control){
    ...
    ItemContentPanel.load('JS/Controls/CustomSingleChart/tabTemplates.html #tab-6', function () {
        ...
        $(this).find("#CstSigChartSigmaOptionSave").unbind().bind("click",function(ev){
            var newcp=Me.Get('FSProPerty');//获取属性
            ...
            Me.Set('FSProPerty',newcp);//保存属性更改
            Me.RefreshByProPanelUp();//更新显示
            newcp=null;
        });
        var cp=Me.Get('FSProPerty');//获取属性
...
Agi.Controls.FreeShape.BackgroundApply=function(_ControlObj,_BackGroudObj){
    ...
    var cp = _ControlObj.Get('FSProPerty');
