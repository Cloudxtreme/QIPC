...
Agi.Controls.PCChartProrityInit = function (_PCChart) {
    ...
    ItemContent = new Agi.Script.StringBuilder();
    ItemContent.append("<div class='PCChart_Pro_Panel'>");
    ItemContent.append("<table class='PCChart_prortityPanelTable'>");
    ItemContent.append("<tr>");
    ItemContent.append("<td class='PCChart_prortityPanelTabletd0'>标题内容：</td><td colspan='3' class='PCChart_prortityPanelTabletd1'><input id='PCChart_Titletxt' type='text' style='width:70%;'  class='ControlProTextSty' maxlength='20' ischeck='false'><div id='PCChart_TitleSave' class='BasicChartPropSavebuttonsty' title='保存'></div></td>");
    ItemContent.append("</tr>");
    ItemContent.append("<tr>");
    ItemContent.append("<td class='PCChart_prortityPanelTabletd0'>字体样式：</td><td class='PCChart_prortityPanelTabletd1'><select id='PCChart_TitleFontSty'><option selected='selected' value='微软雅黑'>微软雅黑</option><option value='宋体'>宋体</option><option value='黑体'>黑体</option><option value='Arial'>Arial</option></select></td>");
    ItemContent.append("<td class='PCChart_prortityPanelTabletd0'>粗体样式：</td><td class='PCChart_prortityPanelTabletd1'><select id='PCChart_TitleFontWeight'><option selected='selected' value='bold'>粗体</option><option value='Normal'>常规</option></select></td>");
    ItemContent.append("</tr>");
    ItemContent.append("<tr>");
    ItemContent.append("<td class='PCChart_prortityPanelTabletd0'>字体大小：</td><td class='PCChart_prortityPanelTabletd1'><input id='PCChart_TitleFontSize' type='number' value='14' min='8' max='30' class='ControlProNumberSty' defaultvalue='14'/></td>");
    ItemContent.append("<td class='PCChart_prortityPanelTabletd0'>字体颜色：</td><td class='PCChart_prortityPanelTabletd1'><input id='PCChart_TitleFontColor' type='text' value='#000000'/></td>");
    ItemContent.append("</tr>");
    ItemContent.append("<tr>");
    ItemContent.append("<td class='PCChart_prortityPanelTabletd0'>水平方向：</td><td class='PCChart_prortityPanelTabletd1'><select id='PCChart_TitleHorDir'><option value='left'>居左</option><option value='center' selected='selected'>居中</option><option value='right'>居右</option></select></td>");
    //    ItemContent.append("<td class='PCChart_prortityPanelTabletd0'>垂直方向：</td><td class='PCChart_prortityPanelTabletd1'><select id='PCChart_TitleVirDir'><option value='top' selected='selected'>居上</option><option value='middle'>居中</option><option value='bottom'>居下</option></select></td>");
    ItemContent.append("<td class='PCChart_prortityPanelTabletd0'>垂直方向：</td><td class='PCChart_prortityPanelTabletd1'><select id='PCChart_TitleVirDir'><option value='top' selected='selected'>居上</option></select></td>");
    ItemContent.append("</tr>");
    ...
    if (ThisChartData != null && ThisChartData.length > 0) {
        ...
        ItemContent.append("<td class='prortityPanelTabletd0'>Tip内容：</td><td class='prortityPanelTabletd2'><input type='text'  class='ControlProTextSty' maxlength='20' ischeck='true'/></td>");
        ItemContent.append("</tr>");
        ItemContent.append("<tr>");
        ...
        ItemContent.append("</tr>");
        ItemContent.append("<tr>");
        ItemContent.append("<td class='prortityPanelTabletd0'>Marker大小：</td><td class='prortityPanelTabletd1'><input type='number' value='3' min='0' max='10 ' class='ControlProNumberSty' defaultvalue='0'/></td>");
    ...
    if (ThisChartData != null && ThisChartData.length > 0) {
        ...
        ItemContent.append("<td colspan='3' class='prortityPanelTabletd2'><div class='bsicChartStandline_sty'><input id='TxtProPanelStandLineName' type='text'  class='ControlProTextSty' maxlength='10' ischeck='true'></div><div id='PCChart_standardline_add'  class='bsicChartStandlineAdd'></div><div class='clearfloat'></div></td>");
        ItemContent.append("</tr>");
        ItemContent.append("<tr>");
        ...
        ItemContent.append("</tr>");
        ItemContent.append("<tr>");
        ItemContent.append("<td class='prortityPanelTabletd0'>线宽：</td><td class='prortityPanelTabletd1'><input  id='PCChart_standardline_size' type='number' value='2' min='1' max='10' class='ControlProNumberSty' defaultvalue='2'/></td>");
    ...
    ItemContent.append("<td class='prortityPCChartTabletd0'>USL</td><td class='prortityPCChartTabletd1'><div class='selectDivClass'>" +
        "<input id='PCChartPropertyUSL' type='number' min='0' max='1000' class='ControlProNumberSty' value='' style='width: 100px'/>" +
        "</td></div>")
    ItemContent.append("<td class='prortityPCChartTabletd0'>LSL</td><td class='prortityPCChartTabletd1'><div class='selectDivClass'>" +
        "<input type='number' min='0' max='1000' class='ControlProNumberSty' id='PCChartPropertyLSL' value='' style='width: 100px'/></div></td>");
    ItemContent.append("</tr>")
    ItemContent.append("<tr>")
    ItemContent.append("<td class='prortityPCChartTabletd0'>目标</td><td class='prortityPCChartTabletd1'><div class='colorDivClass'>" +
        "<input type='number' min='0' max='50000' class='ControlProNumberSty' id='PCChartPropertyTarget' value='' style='width: 100px'></div></td>")
    ItemContent.append("<td class='prortityPCChartTabletd0'>每组大小</td><td class='prortityPCChartTabletd1'><div class='colorDivClass'>" +
        "<input type='number' min='1' max='10' class='ControlProNumberSty' id='PCChartPropertyNrow' value='' style='width: 100px'></div></td>")
    ItemContent.append("</tr>")
    ItemContent.append("<tr>");
    ...
    //20130529 倪飘 解决bug，业务控件-过程能力图表，标题设置中字体颜色设置，应为颜色选择控件，现在为输入框
    $("#PCChart_TitleFontColor").spectrum({
        showInput: true,
        showPalette: true,
        palette: [
            ['black', 'white'],
    ...
    $("#PCChart_TitleSave").die("click");
    $("#PCChart_TitleSave").live("click", function (ev) {
        var Yvalue = null;
        ChartOptions.title = {
            align: $("#PCChart_TitleHorDir").val(),
            floating: false,
            //            margin:30,
            text: $("#PCChart_Titletxt").val(),
            verticalAlign: null,
            style: {
                fontFamily: $("#PCChart_TitleFontSty").val(),
                fontWeight: $("#PCChart_TitleFontWeight").val(),
                color: $("#PCChart_TitleFontColor").val(),
                fontSize: $("#PCChart_TitleFontSize").val() + "px"
            }
            //            ,y:Yvalue
        }
