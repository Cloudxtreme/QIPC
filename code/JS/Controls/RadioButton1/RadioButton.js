            ...
            AgiCommonDialogBox.Confirm("若添加自定义数据将清空实体数据，是否切换？", null, function (flag) {
                if (flag) {
                   // _RadioButtonControl.IsUserDefined=true;
                    ...
                    $("#UserDefined").val("添　加");
                    radioButtonBasicProperty.EntityNum = 3;
                    radioButtonBasicProperty.ItemNum = 3;
                    radioButtonBasicProperty.ShowCounts = 5;
                    radioButtonBasicProperty.RadioButtonText = ["radio0","radio1","radio2"];
                    radioButtonBasicProperty.RadioButtonValue = ["0","1","2"];
