...
Agi.Controls.RealTimeLable = Agi.OOP.Class.Create(Agi.Controls.ControlBasic,
    {
        ...
        ReadRealData:function (MsgObj) {
            ...
            if (BasicProperty._StartParam && BasicProperty._Param.length > 0) {
                ...
                if (Object.prototype.toString.call(_Param) === "[object Object]") {
                    ...
                    var _key = parseInt(_Param._Key, 10);
                    switch (_Operation) {
                        case "大于":
                            if (RTPValue > _key) {
        ...
        Init:function (_Target, _ShowPosition, savedId) {/*控件初始化，_Target：显示到的容器，_ShowPosition：控件显示到的位置,left,top*/
            ...
            var BasicProperty = {
                ...
                _Top:true,
                _Contract:true,
                _LableBgColor:"#ffffff",
                _LableFontColor:"#000000",
            ...
            //20130515 倪飘 解决bug，组态环境中拖入实时标签控件以后拖入容器框控件，容器框控件会覆盖实时标签控件（容器框控件添加背景色以后能够看到效果）
...
//                    controlObject.find('.selectPanelFooterSty').css("border-bottom-right-radius", BasicProperty._LabRB + "px");
        ...
        CreateControl:function (_Config, _Target) {
            if (_Config != null) {
                ...
                var self = this;
                self.currentTagName =  BasicProperty._RealTimePoint;
...
Agi.Controls.RealTimeLableProrityInit = function (_RealTimeLable) {
    ...
    ItemContent = $('<div class="RealTimeLable_Pro_Panel">' +
        ...
        '<tr>' +
        '<td class="RlTimeLable_prortityPanelTabletd0">背景色:</td><td class="RlTimeLable_prortityPanelTabletd1"><div id="_BgColor" style="background-color:#ffffffff;" class="ControlColorSelPanelSty"></div><input type="checkbox" data-field="_bgCTransparent" id="_bgCTransparent" title="透明色" style="display: none;"/></td>' +
        '<td class="RlTimeLable_prortityPanelTabletd0">字体颜色:</td><td class="RlTimeLable_prortityPanelTabletd1"><input class="BasicColor" data-field="_FontColor" id="_FontColor"/></td>' +
        '</tr>' +
        '<tr>' +
        '<td class="RlTimeLable_prortityPanelTabletd0">边框宽度：</td><td type="text" class="RlTimeLable_prortityPanelTabletd1"><input data-field="borderSize" id="RealTLableBorder_Size" type="number" value="0" min="0" max="10" class="ControlProNumberSty" defaultvalue="0"/></td>' +
        '<td class="RlTimeLable_prortityPanelTabletd0">边框颜色:</td><td type="text" class="RlTimeLable_prortityPanelTabletd1"><input class="BasicColor" style="display: none" data-field="_BorderColor" id="_BorderColor"/> </td>' +
        '</tr>' +
        '<tr>' +
        '<td class="RlTimeLable_prortityPanelTabletd0">文本缩进:</td><td colspan="3"  class="RlTimeLable_prortityPanelTabletd1"><input data-field="TxtIndent" id="RealTLableTxt_Indent" type="number" value="0" min="0" max="30" class="ControlProNumberSty" defaultvalue="0"/></td>' +
        '</tr>' +
        '<tr>' +
        '<td class="RlTimeLable_prortityPanelTabletd0">字体大小:</td><td  class="RlTimeLable_prortityPanelTabletd1"><input data-field="txtFontSize" id="txtFontSize" type="number" value="16" min="5" max="100" class="ControlProNumberSty" defaultvalue="16"/></td>' +
        ...
        '</tr>' +
        '<tr>' +
        '<td class="RlTimeLable_prortityPanelTabletd0">左上角半径:</td><td  class="RlTimeLable_prortityPanelTabletd1"><input data-field="LabLT" id="LabLT" type="number" value="0" min="0" max="100" class="ControlProNumberSty" defaultvalue="0"/></td>' +
        '<td class="RlTimeLable_prortityPanelTabletd0">右上角半径:</td><td class="RlTimeLable_prortityPanelTabletd1"><input data-field="LabRT" id="LabRT"type="number" value="0" min="0" max="100" class="ControlProNumberSty" defaultvalue="0"/></td>' +
        '</tr>' +
        '<tr>' +
        '<td class="RlTimeLable_prortityPanelTabletd0">左下角半径:</td><td  class="RlTimeLable_prortityPanelTabletd1"><input data-field="LabLB" id="LabLB" type="number" value="0" min="0" max="100" class="ControlProNumberSty" defaultvalue="0"/></td>' +
        '<td class="RlTimeLable_prortityPanelTabletd0">右下角半径:</td><td class="RlTimeLable_prortityPanelTabletd1"><input  data-field="LabRB" id="LabRB" type="number" value="0" min="0" max="100" class="ControlProNumberSty" defaultvalue="0"></td>' +
        '</tr>' +
        '<tr>' +
        '<td class="RlTimeLable_prortityPanelTabletd0">点位号:</td><td colspan="3" class="RlTimeLable_prortityPanelTabletd1"><input data-field="LabRealTime" id="LabRealTime" type="text"  class="ControlProTextSty" maxlength="20" ischeck="false"/></td>' +
        '</tr>' +
        '<tr>' +
    ...
    ItemContent = $('<div class="RealTimeLable_Pro_Panel">' +
        '<table  class="RlTimeLable_prortityPanelTable" border="0" cellspacing="1" cellpadding="0">' +
        '<tr>' +
        '<td class="RlTimeLable_prortityPanelTabletd0">规则配置:</td><td colspan="3" class="RlTimeLable_prortityPanelTabletd1"><input type="button" id="_btnRules" value="配置规则" /></td>' +
        '</tr>' +
        '</table>' +
        '</div>');
    ...
    $("#LabRealTime").val(self.currentTagName);

    if (BasicProperty._LableBgColor != null && BasicProperty._LableBgColor != "") {
    } else {
        BasicProperty._LableBgColor = { "type": 1, "rgba": "rgba(0,0,0,0)", "hex": "ffffff", "ahex": "ffffffff", "value": { "background": "rgba(0,0,0,0)"} };
    }

    Agi.Controls.ControlColorApply.fColorControlValueSet("_BgColor", BasicProperty._LableBgColor, true); //背景设置初始化
    $("#_BgColor").unbind().bind("click", function () {
        ...
        Agi.Controls.ControlColorApply.fEditColor(oThisSelColorPanel, [2], true, function (color) {
            ...
            BasicProperty._LableBgColor = color;
            self.Set('BasicProperty', BasicProperty);
        });
    });


    $("#RealTLableTxt_Indent").val(BasicProperty._TxtIndent);
    $("#RealTLableBorder_Size").val(BasicProperty._LableBorderSize);
    ...
    //颜色控件赋值一定要放在颜色控件初始化的后面
    $("#_FontColor").spectrum("set", BasicProperty._LableFontColor);
    $("#_BorderColor").spectrum("set", BasicProperty._LableBorderColor);
    ...
    $('.RlTimeLable_prortityPanelTabletd1>input,.RlTimeLable_prortityPanelTabletd1>select').change(function (obj) {
        ...
        switch (pName) {
            ...
            case "txtFontSize":
                ...
                var DefaultValue = parseInt($(this).attr("defaultvalue"));
                ...
                if (v.trim() === "") {
                    var DilogboxTitle = "您输入的数值不在" + MinNumber + "-" + MaxNumber + "范围内，将恢复默认值" + DefaultValue + "！";
                    AgiCommonDialogBox.Alert(DilogboxTitle);
                    $(this).val(DefaultValue);
                }
                else {
                    if (v >= MinNumber && v <= MaxNumber) {
                        BasicProperty._LableFontSize = v;
                    }
                    else {
                        var DilogboxTitle = "您输入的数值不在" + MinNumber + "-" + MaxNumber + "范围内，将恢复默认值" + DefaultValue + "！";
                        AgiCommonDialogBox.Alert(DilogboxTitle);
            ...
            case "_BgColor":
                ...
                break
            case "borderSize":
                //20130402 倪飘 解决bug，实时标签控件中设置边框为11后点击空白处弹出提示框，确定以后边框宽度输入框中显示值变为0但是控件中依然显示边框
                var v = $(this).val();
                var MinNumber = parseInt($(this).attr("min"));
                var MaxNumber = parseInt($(this).attr("max"));
                var DefaultValue = parseInt($(this).attr("defaultvalue"));
                ...
                if (v.trim() === "") {
                    var DilogboxTitle = "您输入的数值不在" + MinNumber + "-" + MaxNumber + "范围内，将恢复默认值" + DefaultValue + "！";
                    AgiCommonDialogBox.Alert(DilogboxTitle);
                    $(this).val(BasicProperty._LableBorderSize);
                }
                else {
                    if (v >= MinNumber && v <= MaxNumber) {
                        BasicProperty._LableBorderSize = v;
                    } else {
                        var DilogboxTitle = "您输入的数值不在" + MinNumber + "-" + MaxNumber + "范围内，将恢复默认值" + DefaultValue + "！";
                        AgiCommonDialogBox.Alert(DilogboxTitle);
                        $(this).val(BasicProperty._LableBorderSize);
                ...
                //                BasicProperty._LableBorderSize = $("#RealTLableBorder_Size").val();
                break
            case "TxtIndent":
                //20130402 倪飘 解决bug，实时标签控件中设置文本缩进为31并点击空白处,弹出信息提示并确定以后文本缩进输入框中显示值与控件中文本缩进值不一致
                var v = $(this).val();
                var MinNumber = parseInt($(this).attr("min"));
                var MaxNumber = parseInt($(this).attr("max"));
                var DefaultValue = parseInt($(this).attr("defaultvalue"));
                ...
                //                BasicProperty._TxtIndent = $("#RealTLableTxt_Indent").val();
                break
        }
        _RealTimeLable.Set('BasicProperty', BasicProperty);
    });
    ...
    $("#_btnRules").click(function () {
        ...
        $('#RealTimeLableParam').modal({ backdrop: true, keyboard: false, show: true }); //加载弹出层
    ...
    $("#GridParame").kendoGrid({
        ...
        columns:[
            ...
            },
            {
                ...
                width:80,
                title:"显示文本",
                template:"<input type='text' id ='_txtValue' class='ControlProTextSty' maxlength='20' ischeck='false'>"
            },
            {
                field:"_txtColor",
                align:"center",
