...
Agi.Controls.PCChartProrityInit = function (_PCChart) {
    ...
    ItemContent.append("<td class='SpcDemoPCChart_prortityPanelTabletd0'>标题内容：</td><td colspan='3' class='SpcDemoPCChart_prortityPanelTabletd1'><input id='SpcDemoPCChart_Titletxt' type='text' style='width:70%;'  class='ControlProTextSty' maxlength='20' ischeck='false'><div id='SpcDemoPCChart_TitleSave' class='BasicChartPropSavebuttonsty' title='保存'></div></td>");
    ItemContent.append("</tr>");
    ItemContent.append("<tr>");
    ...
    ItemContent.append("</tr>");
    ItemContent.append("<tr>");
    ItemContent.append("<td class='SpcDemoPCChart_prortityPanelTabletd0'>字体大小：</td><td class='SpcDemoPCChart_prortityPanelTabletd1'><input id='SpcDemoPCChart_TitleFontSize' type='number' value='14' min='8' max='30' class='ControlProNumberSty' defaultvalue='14'/></td>");
