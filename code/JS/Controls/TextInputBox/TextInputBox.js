...
Agi.Controls.TextInputBoxPropertyInit = function (propertyTextInputBox) {
    ...
    //20140218 范金鹏 添加字体属性选择框
    InputContent.append("<tr>");
    InputContent.append("<td class='prortityPanelTabletd0txtinputbo'>字体样式：</td><td class='prortityLabelTabletd1'><div><select id='FontFamilySelect'>" +
    ...
    //20140218 范金鹏 字体样式初始化
    $("#FontFamilySelect").val(TextInputBoxBasicProperty.FontFamily);
    //end
    ...
    $("#FontFamilySelect").change(function () {
        ...
        TextInputBoxBasicProperty.FontFamily = val;
        propertyTextInputBox.Set("TextInputBoxBasicProperty", TextInputBoxBasicProperty);
    });
    //end
}
