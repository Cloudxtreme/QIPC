...
Agi.Script.KeyBordEvent={
    ControlKeyDown:function(){},
    ControlKeyUp:function(){},
    Control_Z:function(){},
    Control_Shift_Z:function(){},
    Control_Plus:function(){},
    Control_Lower:function(){},
    Control_S:function(){},
    Control_C:function(){},
    Control_X:function(){},
    Control_V:function(){},
    ...
    Control_Left:function(){},
    Control_Right:function(){},
    Up:function(){},
    Down:function(){},
    Left:function(){},
    Right:function(){},
    Delete:function(){},
    IsKeyDownControl:false
}
var k = new Kibo();
k.down('ctrl z', function(ev) {
    if(ev.shiftKey){
        Agi.Script.KeyBordEvent.Control_Shift_Z();
    }else{
        Agi.Script.KeyBordEvent.Control_Z();
    }
})
.down('ctrl s', function() {
        Agi.Script.KeyBordEvent.Control_S();
        return false;
    })
.down('ctrl +', function() {
        Agi.Script.KeyBordEvent.Control_Plus();
    })
.down('ctrl -', function() {
        Agi.Script.KeyBordEvent.Control_Lower();
    })
.down('up', function(ev) {
        if(ev.ctrlKey){
            Agi.Script.KeyBordEvent.Control_Up();
        }else{
            Agi.Script.KeyBordEvent.Up();
        }
    })
.down('down', function(ev) {
        if(ev.ctrlKey){
            Agi.Script.KeyBordEvent.Control_Down();
        }else{
            Agi.Script.KeyBordEvent.Down();
        }
    })
.down('left', function(ev) {
        if(ev.ctrlKey){
            Agi.Script.KeyBordEvent.Control_Left();
        }else{
            Agi.Script.KeyBordEvent.Left();
        }
    })
.down('right', function(ev) {
        if(ev.ctrlKey){
            Agi.Script.KeyBordEvent.Control_Right();
        }else{
            Agi.Script.KeyBordEvent.Right();
        }
    })
.down('delete', function() {
        Agi.Script.KeyBordEvent.Delete();
    })
.down('ctrl x', function() {
        Agi.Script.KeyBordEvent.Control_X();
    })
.down('ctrl c', function() {
        Agi.Script.KeyBordEvent.Control_C();
    })
.down('ctrl v', function() {
        Agi.Script.KeyBordEvent.Control_V();
    })
.down('ctrl', function() {
        Agi.Script.KeyBordEvent.ControlKeyDown()
})
.up('ctrl', function() {
    Agi.Script.KeyBordEvent.ControlKeyUp();
});

/*是否按下Control键*/
Agi.Script.KeyBordEvent.ControlKeyDown=function(){
    Agi.Script.KeyBordEvent.IsKeyDownControl=true;
}
Agi.Script.KeyBordEvent.ControlKeyUp=function(){
    Agi.Script.KeyBordEvent.IsKeyDownControl=false;
}
