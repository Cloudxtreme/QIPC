        ...
        AbnormalpointFrame:function(PointDataList){
            ...
            $("#errorColumnSlect").html(datacolumn);
                ...
                $("#SaveError").bind('click',function(){
                    ...
                    //重新加载tree
                        agi.using(['../../Abnormalpoint'],function (Abnormalpoint) {
            ...
            $("#AbnormalpointSave").bind('click',function(){
                ...
                agi.using(['../../Abnormalpoint'],function (Abnormalpoint) {
                    ...
                    var jsonString=JSON.stringify({"action":"iMrErrDataSave","dataList":datalist,"ErrField":errfield,"ErrData":errdata,"typeCode":typecode});
                    //endregion
