...
//            Agi.Edit.workspace.controlList.remove(this);
        ...
        Copy:function () {
            if (layoutManagement.property.type == 1) {
                ...
                NewAnimationControl.Init(ParentObj, newPanelPositionpars);
...
Agi.Controls.AnimationControlPropertyInit = function (AnimationControl) {
    ...
    ItemContent.append("<td class='prortityAnimationControlTabletd0'colspan='2'>"
        ...
        + "</td>");
    ItemContent.append("<td class='prortityAnimationControlTabletd0'colspan='2'>"
        + "<input type='text' value='' id='AnimationControlPropertyRealtimeTag'>"
        + "</td>");
    ItemContent.append("</tr>");
    ItemContent.append("<tr>");
    ItemContent.append("<td class='prortityAnimationControlTabletd0'colspan='2'>"
        ...
        + "</td>");
    ItemContent.append("<td class='prortityAnimationControlTabletd0'colspan='2'>"
        + "<input type='text' value='0' id='AnimationControlPropertyBorder'>"
        + "</td>");
    ItemContent.append("</tr>");
    ItemContent.append("<tr>");
    ItemContent.append("<td class='prortityAnimationControlTabletd0'colspan='2'>"
    ...
    ItemContent.append("</tr>");
    ItemContent.append("<tr>");
    ItemContent.append("<td class='prortityAnimationControlTabletd0'colspan='4'>"
