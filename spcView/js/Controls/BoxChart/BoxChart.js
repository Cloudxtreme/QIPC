        ...
        if (_EntityInfo != undefined) {
            ...
            Agi.Utility.RequestData2(_EntityInfo, function (d) {
                ...
                if (BoxChartIsCreate != null && BoxChartIsCreate) {
                    ...
                    Me.Set("IsCreateControls", false); //创建控件
...
Agi.Controls.BoxChartProrityInit = function (_BoxChart) {
    ...
    '<tr>' +
    '<td class="prortityPanelTabletd0">名称:</td><td colspan="2" class="prortityPanelTabletd1"><input data-field="txtyAxisName" id="txtyAxisName" type="text" value=""/></td>' +
    '<td   class="prortityPanelTabletd1"><input type="button" value="确定" id="btnBoxChart"/></td>' +
    '</tr>' +
    '<tr>' +
    '<td class="prortityPanelTabletd0">字体大小：</td><td  class="prortityPanelTabletd1"><input data-field="FontSize" id="FontSize" type="number" value="0" min="5" max="50"/></td>' +
    ...
    '</tr>' +
    '<tr>' +
    '<td class="prortityPanelTabletd0">Y轴上限：</td><td  class="prortityPanelTabletd1"><input data-field="YMax" id="YMax" type="number" value="0" min="100" max="100000"/></td>' +
    '<td class="prortityPanelTabletd0">Y轴下限：</td><td  class="prortityPanelTabletd1"><input data-field="YMin" id="YMin" type="number" value="0" min="0" max="100000"/></td>' +
    '</tr>' +
    '</table>' +
    '</div>');
