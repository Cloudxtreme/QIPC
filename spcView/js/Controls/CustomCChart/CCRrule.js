function CCRclsSigmaFunc(sigmaArray, sigmaRule, checkDataSries)
{
    this.sigmaArray     = sigmaArray;               //所有数据
    this.sigmaRule      = sigmaRule;                //规则
    this.checkDataSries = checkDataSries;           //分组信息
	this.check			= CCRclsSigmaFunc$check;       //调度方法
	this.sigmaRules1	= CCRclsSigmaFunc$sigmaRules1; //规则1
	this.sigmaRules2	= CCRclsSigmaFunc$sigmaRules2; //规则2
	this.sigmaRules3	= CCRclsSigmaFunc$sigmaRules3; //规则3
	this.sigmaRules4	= CCRclsSigmaFunc$sigmaRules4; //规则4
	this.sigmaRules5	= CCRclsSigmaFunc$sigmaRules5; //规则5
	this.sigmaRules6	= CCRclsSigmaFunc$sigmaRules6; //规则6
	this.sigmaRules7	= CCRclsSigmaFunc$sigmaRules7; //规则7
	this.sigmaRules8	= CCRclsSigmaFunc$sigmaRules8; //规则8
    this.sigmaRuleDetail = CCRclsSigmaFunc$getDetail;//根据规则号获取具体规则参数
}

//判定规则调度
function CCRclsSigmaFunc$check()
{
//    this.sigmaRules8();
//    this.sigmaRules7();
//    this.sigmaRules6();
...
//规则1
function CCRclsSigmaFunc$sigmaRules1()
{
	//得到八项规则中的某项K值
	var K;
	//得到八项规则中的某项点的颜色
...
//根据规则号获取具体规则参数
function  CCRclsSigmaFunc$getDetail(ruleNo)
{
    for(var i = 0;i<this.sigmaRule.length;i++){
...
//规则2  连续K点落在中心线同一侧
function CCRclsSigmaFunc$sigmaRules2()
{
    //获取规则
...
function CCRclsSigmaFunc$sigmaRules3()
{
	//得到八项规则中的某项K值
	var K;
	//得到八项规则中的某项点的颜色
...
function CCRclsSigmaFunc$sigmaRules4()
{
	//得到八项规则中的某项K值
	var K;
	//得到八项规则中的某项点的颜色
...
function CCRclsSigmaFunc$sigmaRules5()
{
...
function CCRclsSigmaFunc$sigmaRules6()
{
...
function CCRclsSigmaFunc$sigmaRules7()
{
	//得到八项规则中的某项K值
	var K;
	//得到八项规则中的某项点的颜色
...
function CCRclsSigmaFunc$sigmaRules8()
{
