function PCTRRclsSigmaFunc(sigmaArray, sigmaRule, checkDataSries)
{
    this.sigmaArray     = sigmaArray;               //所有数据
    this.sigmaRule      = sigmaRule;                //规则
    this.checkDataSries = checkDataSries;           //分组信息
	this.check			= PCTRRclsSigmaFunc$check;       //调度方法
	this.sigmaRules1	= PCTRRclsSigmaFunc$sigmaRules1; //规则1
	this.sigmaRules2	= PCTRRclsSigmaFunc$sigmaRules2; //规则2
	this.sigmaRules3	= PCTRRclsSigmaFunc$sigmaRules3; //规则3
	this.sigmaRules4	= PCTRRclsSigmaFunc$sigmaRules4; //规则4
	this.sigmaRules5	= PCTRRclsSigmaFunc$sigmaRules5; //规则5
	this.sigmaRules6	= PCTRRclsSigmaFunc$sigmaRules6; //规则6
	this.sigmaRules7	= PCTRRclsSigmaFunc$sigmaRules7; //规则7
	this.sigmaRules8	= PCTRRclsSigmaFunc$sigmaRules8; //规则8
    this.sigmaRuleDetail = PCTRRclsSigmaFunc$getDetail;//根据规则号获取具体规则参数
}

//判定规则调度
function PCTRRclsSigmaFunc$check()
{
//    this.sigmaRules8();
//    this.sigmaRules7();
//    this.sigmaRules6();
...
//规则1
function PCTRRclsSigmaFunc$sigmaRules1()
{
	//得到八项规则中的某项K值
	var K;
	//得到八项规则中的某项点的颜色
...
//根据规则号获取具体规则参数
function  PCTRRclsSigmaFunc$getDetail(ruleNo)
{
    for(var i = 0;i<this.sigmaRule.length;i++){
...
//规则2  连续K点落在中心线同一侧
function PCTRRclsSigmaFunc$sigmaRules2()
{
    //获取规则
...
function PCTRRclsSigmaFunc$sigmaRules3()
{
	//得到八项规则中的某项K值
	var K;
	//得到八项规则中的某项点的颜色
...
function PCTRRclsSigmaFunc$sigmaRules4()
{
	//得到八项规则中的某项K值
	var K;
	//得到八项规则中的某项点的颜色
...
function PCTRRclsSigmaFunc$sigmaRules5()
{
...
function PCTRRclsSigmaFunc$sigmaRules6()
{
...
function PCTRRclsSigmaFunc$sigmaRules7()
{
	//得到八项规则中的某项K值
	var K;
	//得到八项规则中的某项点的颜色
...
function PCTRRclsSigmaFunc$sigmaRules8()
{
