function XMRclsSigmaFunc(sigmaArray, sigmaRule, checkDataSries)
{
    this.sigmaArray     = sigmaArray;               //所有数据
    this.sigmaRule      = sigmaRule;                //规则
    this.checkDataSries = checkDataSries;           //分组信息
	this.check			= XMRclsSigmaFunc$check;       //调度方法
	this.sigmaRules1	= XMRclsSigmaFunc$sigmaRules1; //规则1
	this.sigmaRules2	= XMRclsSigmaFunc$sigmaRules2; //规则2
	this.sigmaRules3	= XMRclsSigmaFunc$sigmaRules3; //规则3
	this.sigmaRules4	= XMRclsSigmaFunc$sigmaRules4; //规则4
	this.sigmaRules5	= XMRclsSigmaFunc$sigmaRules5; //规则5
	this.sigmaRules6	= XMRclsSigmaFunc$sigmaRules6; //规则6
	this.sigmaRules7	= XMRclsSigmaFunc$sigmaRules7; //规则7
	this.sigmaRules8	= XMRclsSigmaFunc$sigmaRules8; //规则8
    this.sigmaRuleDetail = XMRclsSigmaFunc$getDetail;//根据规则号获取具体规则参数
}

//判定规则调度
function XMRclsSigmaFunc$check()
{
//    this.sigmaRules8();
//    this.sigmaRules7();
//    this.sigmaRules6();
...
//规则1
function XMRclsSigmaFunc$sigmaRules1()
{
	//得到八项规则中的某项K值
	var K;
	//得到八项规则中的某项点的颜色
...
//根据规则号获取具体规则参数
function  XMRclsSigmaFunc$getDetail(ruleNo)
{
    for(var i = 0;i<this.sigmaRule.length;i++){
...
//规则2  连续K点落在中心线同一侧
function XMRclsSigmaFunc$sigmaRules2()
{
    //获取规则
...
function XMRclsSigmaFunc$sigmaRules3()
{
	//得到八项规则中的某项K值
	var K;
	//得到八项规则中的某项点的颜色
...
function XMRclsSigmaFunc$sigmaRules4()
{
	//得到八项规则中的某项K值
	var K;
	//得到八项规则中的某项点的颜色
...
function XMRclsSigmaFunc$sigmaRules5()
{
...
function XMRclsSigmaFunc$sigmaRules6()
{
...
function XMRclsSigmaFunc$sigmaRules7()
{
	//得到八项规则中的某项K值
	var K;
	//得到八项规则中的某项点的颜色
...
function XMRclsSigmaFunc$sigmaRules8()
{
