function XSclsSigmaFunc(sigmaArray, sigmaRule, checkDataSries)
{
    this.sigmaArray     = sigmaArray;               //所有数据
    this.sigmaRule      = sigmaRule;                //规则
    this.checkDataSries = checkDataSries;           //分组信息
	this.check			= XSclsSigmaFunc$check;       //调度方法
	this.sigmaRules1	= XSclsSigmaFunc$sigmaRules1; //规则1
	this.sigmaRules2	= XSclsSigmaFunc$sigmaRules2; //规则2
	this.sigmaRules3	= XSclsSigmaFunc$sigmaRules3; //规则3
	this.sigmaRules4	= XSclsSigmaFunc$sigmaRules4; //规则4
	this.sigmaRules5	= XSclsSigmaFunc$sigmaRules5; //规则5
	this.sigmaRules6	= XSclsSigmaFunc$sigmaRules6; //规则6
	this.sigmaRules7	= XSclsSigmaFunc$sigmaRules7; //规则7
	this.sigmaRules8	= XSclsSigmaFunc$sigmaRules8; //规则8
    this.sigmaRuleDetail = XSclsSigmaFunc$getDetail;//根据规则号获取具体规则参数
}

//判定规则调度
function XSclsSigmaFunc$check()
{
    this.sigmaRules8();
    this.sigmaRules7();
    this.sigmaRules6();
...
//规则1
function XSclsSigmaFunc$sigmaRules1()
{
	//得到八项规则中的某项K值
	var K;
	//得到八项规则中的某项点的颜色
...
//根据规则号获取具体规则参数
function  XSclsSigmaFunc$getDetail(ruleNo)
{
    for(var i = 0;i<this.sigmaRule.length;i++){
...
//规则2  连续K点落在中心线同一侧
function XSclsSigmaFunc$sigmaRules2()
{
    //获取规则
...
function XSclsSigmaFunc$sigmaRules3()
{
	//得到八项规则中的某项K值
	var K;
	//得到八项规则中的某项点的颜色
...
function XSclsSigmaFunc$sigmaRules4()
{
	//得到八项规则中的某项K值
	var K;
	//得到八项规则中的某项点的颜色
...
function XSclsSigmaFunc$sigmaRules5()
{
...
function XSclsSigmaFunc$sigmaRules6()
{
...
function XSclsSigmaFunc$sigmaRules7()
{
	//得到八项规则中的某项K值
	var K;
	//得到八项规则中的某项点的颜色
...
function XSclsSigmaFunc$sigmaRules8()
{
