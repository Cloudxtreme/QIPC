...
//            Agi.Edit.workspace.addParameter(ID + ".SelValue", 0);
            ...
            //20130515 倪飘，解决bug，多选下拉列表框预览时候，鼠标移动到控件右边框或者边框时候鼠标形状会变成可拖动状态
            //缩小的最小宽高设置
...
Agi.Controls.MultiSelectProrityInit = function (MultiSelectControl) {
    ...
    ItemContent.append("</tr>");
    ItemContent.append("<tr>");
    ItemContent.append("<td class='MultiSelectProTabtd0'>文字缩进：</td><td class='MultiSelectProTabtd1' colspan='3'><input type='number' title='文字缩进' min='0' max='30' defaultvalue='0' value='0' id='MultiSel_TxtIndent' class='MultiSelectNumberSty'/></td>");
    ItemContent.append("</tr>");
    ItemContent.append("<tr>");
