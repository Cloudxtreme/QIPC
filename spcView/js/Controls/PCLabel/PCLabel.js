...
Agi.Controls.PCLabel = Agi.OOP.Class.Create(Agi.Controls.ControlBasic,
{
...
//        Agi.Edit.workspace.currentControls.length = 0; /*清除选中控件对象*/
    ...
    Copy: function () {
        if (layoutManagement.property.type == 1) {
            ...
            var NewPCLabel = new Agi.Controls.PCLabel();
    ...
    GetConfig: function () {
        ...
        PCLabelControl.Control.PCLabel = ProPerty.BasciObj;
    ...
    ChangeTheme: function (_themeName) {
        ...
        //3.应用当前控件的信息
        Agi.Controls.PCLabel.OptionsAppSty(StyleValue, this);
    }
});
...
//拖拽控件至编辑页面时，初始控件的方法
Agi.Controls.InitPCLabel = function () {
    return new Agi.Controls.PCLabel();
}
...
Agi.Controls.PCLabelProrityInit = function (_PCLabel) {
    ...
    '<tr>' +
   '<td class="prortityPanelTabletd0">USL:</td><td  class="prortityPanelTabletd1"><input data-field="USL" id="USL" type="text" value="" /></td>' +
   '<td  class="prortityPanelTabletd0">LSL:</td><td  class="prortityPanelTabletd1"><input data-field="LSL" id="LSL" type="text" value=""/></td>' +
    '</tr>' +
    '<tr>' +
    '<td class="prortityPanelTabletd0">目标:</td><td  class="prortityPanelTabletd1"><input data-field="Target" id="Target" type="text" value=""/></td>' +
    '<td class="prortityPanelTabletd0">组数:</td><td  class="prortityPanelTabletd1"><input data-field="Nrow" id="Nrow" type="text" value=""/></td>' +
    '</tr>' +
     '<tr>' +
