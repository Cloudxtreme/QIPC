...
Agi.Controls.TimePickerProrityInit=function(dropDownControl){
    ...
    ItemContent.append("<div class='TimePickerProperty'>字体大小：<input type='number' min='13' max='20' id='fontsizenum' class='propetycontro'/></div>");
    ItemContent.append("<div class='TimePickerProperty'>日历皮肤：<select id='CalendarSkinSelect'>" +
